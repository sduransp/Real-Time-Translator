...
class RealTimeTranslator:
    def __init__(self, model="tiny", non_english=True, output_language="German", energy_threshold=1000, record_timeout=3, phrase_timeout=3, default_microphone='pulse', output_device=0):
